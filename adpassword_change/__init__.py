...
class AD_Password:
    def __init__(self, top=None):
        ...
        self.lbl_old_pwd.place(relx=0.04, rely=0.08, height=17, width=120)
        ...
        self.lbl_old_pwd.configure(text=_('''Old Password'''))

        self.lbl_new_pwd = ttk.Label(top)
        self.lbl_new_pwd.place(relx=0.04, rely=0.21, height=17, width=120)
        ...
        self.lbl_new_pwd.configure(text=_('''New Password'''))

        self.TEntry1 = ttk.Entry(top)
        self.TEntry1.place(relx=0.42, rely=0.08, relheight=0.08, relwidth=0.34)
        ...
        self.lbl_rep_new_pwd.place(relx=0.04, rely=0.33, height=17, width=170)
        ...
        self.lbl_rep_new_pwd.configure(text=_('''Repeat New Password'''))

        self.TEntry2 = ttk.Entry(top)
        self.TEntry2.place(relx=0.42, rely=0.21, relheight=0.08, relwidth=0.34)
        ...
        self.TEntry3.place(relx=0.42, rely=0.33, relheight=0.08, relwidth=0.34)
        ...
        self.bt_ok.configure(text=_('''Ok'''))
        ...
        self.TButton2.configure(text=_('''Cancel'''))
